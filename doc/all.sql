...
insert into `category` (id, parent, name, sort) values (302,300,'进阶方向',302);
...
create table `doc` (
    `id` bigint not null comment 'id',
    `ebook_id` bigint not null default 0 comment '文献id',
    `parent` bigint not null default 0 comment '父id',
    `name` varchar(50) not null comment '名称',
    `sort` int comment '顺序',
...
insert into `user` (id, login_name, name, password) values (1, 'test', '测试', '111111');
